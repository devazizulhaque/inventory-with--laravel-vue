    ...
    <aside class="sidebar-wrapper">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Employee">
                <button class="nav-link" data-bs-toggle="pill" data-bs-target="#pills-employee" type="button"><i class="fadeIn animated bx bx-user-pin"></i></button>
            </li>
        ...
        <div class="brand-logo">
            <img src="/admin/assets/images/brand-logo-2.png" width="140" alt=""/>
        </div>
        <div class="tab-content">
            ...
            <div class="list-group list-group-flush">
                ...
                <router-link :to="{name: 'dashboard'}" class="list-group-item"><i class="bi bi-speedometer2"></i>Dashboard</router-link>
            </div>
            </div>
            <div class="tab-pane fade" id="pills-employee">
                <div class="list-group list-group-flush">
                    ...
                    <router-link :to="{name: 'employee'}" class="list-group-item"><i class="fadeIn animated bx bx-group"></i>Employee List</router-link>
                    <router-link :to="{name: 'employee-add'}" class="list-group-item"><i class="fadeIn animated bx bx-user-plus"></i>Add Employee</router-link>
                </div>
            </div>
...
.router-link-exact-active{
    ...
    background-color: hsl(216deg 98% 52% / 12%) !important;
    border-color: rgb(52 97 255 / 12%) !important;
}
.bx{
    font-size: 20px;
}
